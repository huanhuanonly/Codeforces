 ...
 * 
 * => D. Two Melodies ( @c 2600 )
 * 
 * -> https://codeforces.com/contest/813/problem/D
 * 
 * Submissions ~> https://codeforces.com/contest/813/submission/346998630 By huanhuanonly
 * 
 * @b SPFA-Dinic for @a Maximum-cost-maximum-flow
 * 
 * ----November 02, 2025 [01h:14m:28s]----
*/
...
int main(void)
{
    ...
    dinic.add_edge(dinic.source, sub_source, 2, 0);
